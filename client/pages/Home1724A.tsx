      ...
      <main className="w-full">
        ...
        <section className="w-full h-[750px] bg-[#EDEDED] flex items-center justify-center relative">
          <div className="max-w-[1290px] w-full mx-auto px-[315px] flex items-center justify-between">
            ...
            <div
              ...
              style={{
                background: `url('https://cdn.builder.io/api/v1/image/assets%2Fa757fd58e3b840c7ae6034a3b5a84411%2F1724A-1.jpg') lightgray center / cover`,
              }}
            ></div>
          </div>
        </section>
        ...
        <section className="max-w-[1290px] mx-auto px-[315px] py-[50px]">
          ...
          <div className="flex justify-center">
            <img
              src="https://cdn.builder.io/api/v1/image/assets%2Fa757fd58e3b840c7ae6034a3b5a84411%2Ffloor-plan-1724.jpg"
              alt="Floor plan 1724"
