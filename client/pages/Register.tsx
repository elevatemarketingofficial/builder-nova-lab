          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-2">
                ...
                <span className="text-[#F56C6C] text-[15px] leading-[24.75px]">
                  {" "}
                  *
                </span>
            ...
            <div className="w-[302px] h-[76px] border border-[#D3D3D3] bg-[#F9F9F9] rounded-[3px] p-4 flex items-center justify-between shadow-sm">
              ...
              <div className="flex flex-col items-center">
                ...
                />
                <span
                  className="text-[#555] text-[10px] leading-[10px] text-center mt-1"
                  style={{
                    fontFamily:
                      "Roboto, -apple-system, Roboto, Helvetica, sans-serif",
                  }}
              ...
              <div
                className="absolute bottom-2 right-4 flex items-center gap-1 text-[8px] text-[#555]"
                style={{
                  fontFamily:
                    "Roboto, -apple-system, Roboto, Helvetica, sans-serif",
                }}
