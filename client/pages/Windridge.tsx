        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div className="bg-orange-50 p-8 text-center">
              ...
              <h3 className="text-sm font-bold text-gray-800 uppercase mb-2">Bedrooms</h3>
              <div className="text-2xl font-bold text-brand-gold">5</div>
              <div className="text-sm font-bold text-brand-gold">including main floor bedroom</div>
            </div>
            ...
            <div className="bg-orange-50 p-8 text-center">
              ...
              <h3 className="text-sm font-bold text-gray-800 uppercase mb-2">Bathrooms</h3>
            ...
            <div className="bg-orange-50 p-8 text-center">
              ...
              <h3 className="text-sm font-bold text-gray-800 uppercase mb-2">Square Footage</h3>
              <div className="text-xl font-bold text-brand-gold">1,791 sq. ft</div>
            </div>
            ...
            <div className="bg-orange-50 p-8 text-center">
              ...
              <h3 className="text-sm font-bold text-gray-800 uppercase mb-2">Garage</h3>
              <div className="text-xl font-bold text-brand-gold">2 Car Tandem Garage</div>
            </div>
          </div>
          ...
          <div className="text-center max-w-5xl mx-auto">
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Experience this home that is modern, warmly welcoming and tastefully designed. This floorplan was designed for those with
              the preference of having a bedroom and bathroom on the main floor. Also on the first floor you are met with a well-
              appointed kitchen featuring plenty of cabinet space and a pantry. On the second floor you will find a spacious owner's suite
              with a walk-in closet and dual vanity. The additional 4 bedrooms, 2 full baths and laundry room are also conveniently
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="text-white mb-8 lg:mb-0">
              <h2 className="text-3xl font-bold mb-4">Join the<br />Interested List</h2>
              <p className="text-lg">
