  ...
  return (
    <div className="min-h-screen bg-[#FAFBFC]">
      ...
      <main>
        ...
        <section className="bg-[#D29A3A] py-[55px] lg:py-[80px]">
          <div className="max-w-[1920px] mx-auto px-4 lg:px-[400px]">
            <div className="text-white">
              ...
              <h1 className="text-[48px] lg:text-[64px] font-bold leading-[52px] lg:leading-[68px]">
                GET IN TOUCH
              </h1>
            </div>
          </div>
        ...
        <section className="bg-white py-[55px] lg:py-[80px]">
          <div className="max-w-[730px] mx-auto px-4">
            ...
            <div className="flex justify-center mb-8">
              <img
                ...
                alt="Contact"
                className="w-[108px] h-[108px] rounded-full border-3 border-[rgba(210,154,58,0.34)]"
              />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="px-[5px]">
                <button
                  type="submit"
                  className="w-[209px] h-[40px] bg-[#69727D] text-white rounded-[3px] text-[15px] font-medium hover:bg-opacity-90 transition-colors flex items-center justify-center"
                >
                  Submit
                </button>
              </div>
